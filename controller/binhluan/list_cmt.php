...
<div class="sidebar-widget">
        ...
        <div class="sidebar-search mb-40 mt-20">
            <form class="sidebar-search-form" action="index.php?act=list_cmt" method="post">
...
<table class="table">
  ...
  <tbody>
    ...
    $stt = 1;
    foreach((isset($list) ? $list : $listcmt) as $item){
    ?>
    <tr>
      ...
      <td>
      <a style="color:black" href="index.php?act=dele_cmt&id=<?php echo $item['binh_luan_id']?>" onclick="return confirm('Bạn có xác nhận xóa không?')">Xóa</a>
...
<ul style="list-style:none;display: flex;justify-content: center;">
    <?php if ($current_page > 1) { ?>
        <li><a id="page_item" style="color:black" class="prev" href="index.php?act=list_cmt&page=<?php echo $current_page - 1; ?>"><i class="la la-angle-left"></i></a></li>
    <?php } ?>

    <?php if ($current_page > 3) { ?>
        <li><a id="tab_pre" href="index.php?act=list_cmt&page=1">1</a></li>
