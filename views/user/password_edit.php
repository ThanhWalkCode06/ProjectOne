                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">
                                    <div class="tab-content" id="myaccountContent">
                                        <div class="tab-pane show fade active" id="account-info" role="tabpanel">
                                        <div class="myaccount-content">
                                                <h3>Thay đổi mật khẩu</h3>
                                                <div class="account-details-form">
                                                    <form action="index.php?act=password_edit" method="post">
                                                        <fieldset>
                                                            
                                                            <div class="single-input-item">
                                                                <label for="current-pwd" class="required">Mật khẩu hiện tại</label>
                                                                <input type="password" id="current-pwd" name="current_pass" />
                                                                <input type="hidden" id="" name="id" value="<?php echo $_SESSION['id']?>"/>
                                                                <p style="color:red"><?php echo (isset($errCurrent) && $errCurrent != "") ? $errCurrent : "" ?></p>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="single-input-item">
                                                                        ...
                                                                        <p style="color:red"><?php echo (isset($errNew) && $errNew != "") ? $errNew : "" ?></p>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="single-input-item">
                                                                        <label for="confirm-pwd" class="required">Xác nhận</label>
                                                                        <input type="password" id="confirm-pwd" name="confirm_pass" />
                                                                        <p style="color:red"><?php echo (isset($errConfirm) && $errConfirm != "") ? $errConfirm : "" ?></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </fieldset>
