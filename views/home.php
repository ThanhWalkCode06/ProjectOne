...
?>
            ...
            <div class="row align-items-center g-0">
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-12">
                    <div class="slider-sin-img-hm4 slider-sin-mrg4 bg-yellow-light">
                        <img style="height:600px;width:600px;margin-left:150px;margin-top:200px" class="wow fadeInRight" src="views/assets/images/slider/card3.webp" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="product-area pb-70 section-padding-3">
            ...
            <div class="container-fluid">
                <div class="section-title-4 text-center">
                    <h2>Sản Phẩm đang được săn đón nhất dạo gần đây </h2>
                </div>
    ...
    <div style="height:400px;" class="product-wrap product-border-2 pro-hover-shadow mb-40">
        ...
        <div style="height: 250px;" class="product-img mb-15">
            ...
            <div class="product_item product-action-3">
                ...
                background: white;
                " value="Add To Cart" name="addtocart"><i class="la la-cart-plus"></i>
                </button>
                <?php } ?>
            </div>
        </div>
