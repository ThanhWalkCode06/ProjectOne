...
<body>
    <div class="main-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="product-details-content pro-details-content-modify">
                            ...
                            <p style="margin-bottom:20px;margin-top: -10px;">Tồn kho: <?php echo $so_luong?></p>
                            <form action="index.php?act=addcart" method="post">
                                ...
                                <div class="pro-details-quality">
                                        <div class="cart-plus-minus">
                                            <input class="cart-plus-minus-box" type="number" name="sl" value="1" >
                                        </div>
                                    </div>
                            <div class="pro-details-compare-wishlist"></div>
                            <div class="pro-details-buy-now btn-hover btn-hover-radious">
                                <input type="submit" name="addtocart" value="Thêm vào giỏ hàng" <?php echo ($so_luong == 0) ? "disabled" : "" ?>>
                                <p><?php echo ($so_luong == 0) ? "Đã hết sản phẩm" : "" ?></p>
                            </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="ms-auto me-auto col-lg-10">
                        ...
                        <div class="tab-content dec-review-bottom">
                            ...
                            <?php if(isset($list_bl) && $list_bl != []){ $error = "";   
                                ...
                                echo (empty($_SESSION['id'])) ? $error_cmt = "Vui lòng đăng nhập để sử dụng" : $error_cmt
                                ?></h3>
                               ...
                               <textarea style=" width: 100%; height: 100px; box-sizing: border-box; text-align: left; vertical-align: top;"
                                ...
                                <?php echo (isset($_SESSION['id']) ? "" : "disabled")?>>
                               </form>
                            </div>
                        </div>
                    </div>
        ...
        <div style="margin-top:50px" class="product-area pb-85">
            <div class="container">
                        ...
                        <div class="product-content">
                            ...
                            <div class="price-addtocart">
                                ...
                                <div class="product-addtocart">
                                    <a title="Add To Cart" href="index.php?act=addcart&id=<?php echo $item['id'] ?>">+ Add To Cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
============================================ -->
    ...
    <script>
        document.querySelector('.cart-plus-minus-box').addEventListener('click', function() {
            if (this.value < 1) {
                this.value = 1;
            }
        });
