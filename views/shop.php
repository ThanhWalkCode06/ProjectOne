                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                            <div class="product-wrap mb-35">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <h4 class= "name_tag"><a href="index.php?act=detail_pro&id=<?php echo $item['id']?>"><?php echo $item['ten_san_pham']?>.</a></h4>
                                                    <div class="price-addtocart">
                                                        <div class="product-price">
                                                            <span><?php echo number_format($item['gia_san_pham'],'0',',','.')?><span style="color:red;"> VNĐ</span></span>
                                                        </div>
                                                        <div class="product-addtocart">
                                                            <?php if($item['so_luong']){?>
                                            ...
                                            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-6">
                                                <div class="shop-list-content">
                                                    ...
                                                    <div class="product-list-action">
                                                        ...
                                                        <a title="Add To Cart" href="index.php?act=addcart&id=<?php echo $item['id'] ?>"><i class="la la-shopping-cart"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="shop-list-wrap mb-30">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-6">
                                                <div class="shop-list-content">
                                                    <span><?php echo $item['name']?></span>
                                                    <h4 class= "name_tag"><a href="product-details.html"><?php echo $item['ten_san_pham']?>.</a></h4>
                                                    <div class="pro-list-price">
                                                        <span style="color:red;"><?php echo number_format($item['gia_san_pham'],'0',',','.')?></span>
                                                    </div>
                                                    <p><?php echo $item['mo_ta']?>.</p>
                        ...
                        <div class="sidebar-wrapper">
                            ...
                            <div class="sidebar-widget shop-sidebar-border pt-40">
                                ...
                                <div class="shop-catigory mt-20">
                                    <ul id="faq">
                                        <?php if(isset($list_dm)) foreach($list_dm as $item){ ?>
